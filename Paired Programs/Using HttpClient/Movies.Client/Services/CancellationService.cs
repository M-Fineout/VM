...
{
    //Manually cancelling a Task can help free up threads, allowing for faster processing and better performance
    public class CancellationService : IIntegrationService
    {
        ...
        private async Task GetTrailerAndCancel(CancellationToken cancellationToken)
        {
            ...
            //mock time passing before cancellation. In a real-world scenario you would trigger cancellationTokenSource.Cancel on the event of a 'cancel' button being clicked, or some other form of user input
